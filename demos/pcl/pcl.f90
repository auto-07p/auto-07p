...
!   PAR(21) : sigma+: U0(7)-10 (x-distance from section x=10)
!   PAR(22) : sigma-: U1(10)-U0(7) (x-distance between orbit pieces)
!   PAR(23) : eta: gap size for Lin vector
!   PAR(25) : Z_x: Lin vector (y-coordinate)
!   PAR(26) : Z_y: Lin vector (z-coordinate)
!---------------------------------------------------------------------
!---------------------------------------------------------------------
...
! ---------- --- 
  ...
  !--------- ----
    ...
    ELSEIF (NDIM==12) THEN
       ...
       IF (NBC==15) THEN
          ...
          ! gap size in PAR(23)
          PAR(23) = normlv
          ! Lin vector in PAR(25)-PAR(26)
          PAR(25:26) = d(2:3)/normlv
       ENDIF
    ENDIF
  END SUBROUTINE PVLS
  ...
  !--------- ----
    ...
    FB(15) = U1(10) - U0(7) - PAR(22)
    IF (NBC==15) RETURN

    eta = PAR(23)
    FB(16:17) = U0(8:9) - U1(11:12) - eta*PAR(25:26)
