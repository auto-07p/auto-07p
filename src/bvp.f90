...
! Local
    ...
    NSKIP=(NARS+6)/7 - (NDIM+7)/7
    DO J=1,NTSRS
       READ(3,*)TM(J),UPS(1:NDIMRD,J)
       IF(NSKIP>0)CALL SKIP3(NSKIP,EOF3)
       DO I=1,NCOLRS-1
