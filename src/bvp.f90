...
!     don't set global rotations here for homoclinics, but in autlib5.f
    ...
    IF(IPERP/=2)THEN
       ...
       IF(ISP/=0 .AND. (IPS==2.OR.IPS==7.OR.IPS==12) )THEN
          ...
          SP1 = FNSPBV(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
          SP1 = 0.0d0
       ENDIF
    ENDIF
...
! of branches of solutions to general boundary value problems.
    ...
    include 'interfaces.h'
    INTERFACE
       DOUBLE PRECISION FUNCTION FNCS(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
         INTEGER IAP(*),IUZ(*)
         DOUBLE PRECISION RAP(*),PAR(*),VUZ(*),P0(*),P1(*)
...
! Check for zero.
    ...
    Q0=Q
    Q1=FNCS(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
...
! Check for zero.
       ...
       Q=FNCS(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
...
! ------ --------- -------- ------
  DOUBLE PRECISION FUNCTION FNLPBV(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
...
! RETURNS A QUANTITY THAT CHANGES SIGN AT A LIMIT POINT (BVP)
    ...
    INTEGER IAP(*),IUZ(*)
    DOUBLE PRECISION RAP(*),PAR(*),P0(*),P1(*),VUZ(*)
    COMPLEX(KIND(1.0D0)) EV(*)
    LOGICAL CHNG
...
! ------ --------- -------- ------
  DOUBLE PRECISION FUNCTION FNBPBV(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
...
! ------ --------- -------- ------
  DOUBLE PRECISION FUNCTION FNSPBV(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
...
! ------ --------- -------- ------
  DOUBLE PRECISION FUNCTION FNUZBV(IAP,RAP,PAR,CHNG,P0,P1,EV,IUZ,VUZ)
