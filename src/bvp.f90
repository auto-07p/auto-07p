...
! THIS IS THE ENTRY ROUTINE FOR GENERAL BOUNDARY VALUE PROBLEMS.
    ...
    ELSE
       CALL MPI_CNRLBV_WORKER(AP,ICP,FUNI,BCNI,ICNI)
    ENDIF
...
! ---------- -----------------
  SUBROUTINE MPI_CNRLBV_WORKER(AP,ICP,FUNI,BCNI,ICNI)
...
! Local
    ...
    DOUBLE PRECISION, ALLOCATABLE :: PAR(:),THU(:),DTM(:),TM(:)
    ...
    DOUBLE PRECISION DSOLD,DSOLDS(1),RDS,P0(1),P1(1),THL(1)
