...
C
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C
      EXTERNAL FNWS,FUNI,FNDS,FNPS,FNWP,FNPE,FNC1,FNC2,FNLP,FNTI
      ...
      EXTERNAL STPNPO,STPNPB
      EXTERNAL PVLSBV
      EXTERNAL BCPS,BCNI,BCPL,BCPD,BCTR,BCBL,BCPO
      EXTERNAL ICPS,ICNI,ICPE,ICPL,ICPD,ICTR,ICBL,ICPO
C
      INTEGER IAP(*)
C
C-----------------------------------------------------------------------
