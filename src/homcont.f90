...
! ---------- ------
  SUBROUTINE STPNHO(AP,PAR,ICP,NTSR,NCOLRS,RLDOT,UPS,UDOTPS,TM,NODIR)
    ...
    USE BVPCONT, ONLY: STPNBV,STPNBV1
    USE BVP, ONLY: SETRTN
...
! ------ --------- --------
  DOUBLE PRECISION FUNCTION FNCSHO(AP,ICP,UPS,NDIM,PAR,ITEST,ITP)

    USE AUTO_CONSTANTS, ONLY: AUTOPARAMETERS
    USE BVPCONT, ONLY: FNCSBV
    TYPE(AUTOPARAMETERS), INTENT(INOUT) :: AP
    ...
    FNCSHO=FNCSBV(AP,ICP,UPS,NDIM,PAR,ITEST,ITP)
    IF(ITEST>0)RETURN
